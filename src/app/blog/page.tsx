    ...
    <div>
      <main className="pt-[82px] bg-[#F7F7F7] bg-top relative z-[1] pb-[180px]">
        ...
        <section className="bg-white py-[60px] md:py-[100px] lg:py-[180px]">
          <div className="container">
            <h2 className="max-w-[794px] mx-auto text-center mb-[20px] md:mb-[55px]">We’re releasing new updates nearly every week. Stay on top of them here with all our latest company news and views.</h2>
            <EveryWeekPost />
          </div>
        </section>
      </main>
