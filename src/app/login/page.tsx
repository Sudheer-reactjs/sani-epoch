...
const Page: React.FC = () => {
  ...
  return (
    <main
      className="pt-[100px] black-background bg-black bg-cover bg-top relative z-[1]"
    ...
    >
      <div className="w-full max-w-[702px] mx-auto">
        ...
        <div className="customborder grid md:grid-cols-2 gap-4 px-[50px]">
          <button className="relative flex items-center gap-[15px] justify-center bg-[#191919] py-3 px-4 rounded-lg"> 
            Sign up with Google
            <GoogleIcon />
          </button>
